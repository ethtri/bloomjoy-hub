...
export const portalDestinations: PortalDestination[] = [
  ...
  },
  {
    ...
    description: 'Record completed work by machine and view your weekly time.',
  ...
  },
  {
    ...
    description: 'Task-first videos, quick aids, and machine guides.',
    descriptionKey: 'portal.nav.trainingDescription',
    icon: BookOpen,
    access: 'training',
    mobileOrder: 9,
    upsellCopy: 'Unlock the training hub, quick aids, and certificate path.',
