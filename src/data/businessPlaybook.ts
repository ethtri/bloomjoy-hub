...
export const businessPlaybookArticles: BusinessPlaybookArticle[] = [
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "A vending week might mean checking a mall machine on Tuesday morning before the lunch crowd. An event week might mean loading sugar and sticks Saturday at 7 a.m. and managing a line of kids by noon. Same product, very different life.",
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: "Be ready when the venue asks for paperwork",
        body: [
          ...
          "A venue manager might like the idea and then ask, 'Can you send your COI and W-9?' That is not the moment to start figuring out what those documents are.",
