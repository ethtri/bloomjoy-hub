...
const bindingKinds = ['modern_authorized_manual', 'legacy_manual_portal_observation', 'no_attempt_integrity_hold', 'unverified_attempt', 'verified_authorized_api'] as const;
