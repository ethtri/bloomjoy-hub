...
const hasInviteEmailShape = (value) => /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(value.trim());
...
const normalizeLocationOrigin = (locationLike) => {
...
export const resolveAccessInviteLoginOrigin = (locationLike = getBrowserLocation()) => {
  if (!locationLike) {
