...
const overview = (): RefundReceiptOverview => ({ schemaVersion: 'refund_receipt_overview_v1', visible: true,
  ...
  noticeChoices: [], historicalOwnerNoticeAvailable: true, historicalOwnerNoticeCutoff: '2026-09-02T19:51:58Z' });
...
Deno.test('saved historical notice projection preserves operator/no-CC provenance and strips private identities', () => {
  const v = overview();
  const saved = { ...v, historicalOwnerNoticeAvailable: false, senderEmail: 'private', receipt: { ...v.receipt,
