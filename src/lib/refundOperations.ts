...
export type NayaxLookupCandidate = {
  ...
  selectionBlockReason?: 'hard_safety_stop' | 'exact_core_evidence_required' | 'independent_corroboration_required' | null;
  ...
  identifierComparisonClass?: 'match' | 'negative' | 'neutral' | 'internal_review' | 'unavailable' | string;
