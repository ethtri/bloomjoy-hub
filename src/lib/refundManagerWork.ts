...
export const refundManagerNextActionCopy = (actionCode: string) => ({
  ...
  refund_operations: 'The assigned machine Manager or a Super-admin should check the saved Nayax result in the portal. Do not retry payment.',
  reconcile_lifecycle_integrity: 'The assigned machine Manager or a Super-admin should check and correct the saved payment record. Do not retry payment.',
