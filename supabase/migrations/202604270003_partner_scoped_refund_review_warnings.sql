-- Scope partner-preview refund review warnings to deterministic relationships
-- with the selected partner report machines. Broad unresolved refund review
-- counts stay in Admin Reporting Operations.
