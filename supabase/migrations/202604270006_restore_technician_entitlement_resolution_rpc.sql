-- Forward repair for issue #214.
--
-- The Technician invite resolver was introduced during a migration-version
-- collision window around 202604260013 and later renumbered to 202604260016.
-- Re-declare the frontend-facing RPC in a new migration so environments with
-- stale migration history restore the function through the normal Supabase
-- migration workflow, then refresh PostgREST's schema cache.
