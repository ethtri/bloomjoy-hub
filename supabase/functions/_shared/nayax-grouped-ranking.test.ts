...
const candidate = (
  ...
  managerCorroborationCodes: ["card_last4_match"],
  customerCredentialClass: "physical_interaction_unknown",
  customerPaymentInteraction: "unknown",
  customerCardLast4Source: "unknown",
  customerCardLast4Provenance: null,
  ...
  identifierComparisonClass: "match",
