...
const staticChecks = [
  {
    ...
    patterns: [
      ...
      'adminSurface && canAccessSurface(adminSurface)',
      'Your current admin grant does not include this surface.',
      'Admin Access Required',
    ],
  },
  {
    name: 'Scoped Admin Admin Access page exposes scoped person console workflows',
  ...
  {
    name: 'Person console global controls require Super Admin while scoped Technician controls remain available',
    ...
    patterns: [
      ...
      "openAccessLauncher('technician')",
      '{isSuperAdmin && (',
      '<TechnicianAccessCard',
      '<ManualReportingAccessCard',
      '<PlusCustomerAccessCard',
      '<CorporatePartnerAccessCard',
      '<ScopedAdminAccessCard',
  ...
  {
    name: 'Scoped Admin Technician authority is machine-scoped and excludes training-only grants',
    file: 'supabase/migrations/20260625200317_scoped_admin_technician_authority.sql',
    patterns: [
      ...
      "'scoped_admin'",
      'Scoped Admin Technician grants require at least one assigned machine',
      'Scoped Admin can manage only assigned in-scope Technician machines',
      'admin_grant_technician_access',
      'admin_update_technician_machines',
      'admin_revoke_technician_access',
