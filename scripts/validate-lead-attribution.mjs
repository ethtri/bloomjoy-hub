...
const assertions = [
  ...
  ['organic-search classification uses hostname boundaries', client.includes('googleSearchHostPattern') && client.includes('host.endsWith(`.${domain}`)') && !client.includes('host.includes(candidate)')],
