  ...
  const scenarios = [
    ...
    },
    {
      ...
      response: {
        ...
        candidateCount: 1,
        windowHours: 6,
        summary: 'Nayax found one sale on the matching machine for the exact amount. The card details differ, and Nayax has not proved those fields use the same identifier for this payment interaction. Transaction timing is shown separately and may be unproved.',
        recommendedAction: 'Review this sale once and confirm it only if the exact amount, machine, and available customer and payment evidence identify the same purchase. One-click refund stays unavailable.',
        candidates: [
          {
      ...
      expectedManagerNotice: 'Transaction results updated.',
      expectedBadge: 'Needs comparison',
      expectedAction: 'Next: Review Machine transaction once. Select it only if the exact amount, machine, and available customer and payment evidence identify the same purchase.',
      expectedCandidateCount: 1,
