...
export const EXPECTED_SCREENSHOTS = [
  ...
  'refund-owner-totp-readiness.png',
  ...
  'refund-portal-uat-mapped-scoped-admin-mapped-manager-step-up.png',
  'refund-portal-uat-mapped-super-admin-mapped-manager-step-up.png',
