...
const assertions = [
  ...
  ['both routes have unique SEO records and lastmods', seo.includes(`path: FOOD_TRUCK_SOLUTION_PATH`) && seo.includes(`path: MOBILE_SETUP_GUIDE_PATH`) && seo.includes('"/solutions/food-trucks": "2026-08-09"')],
