...
- [ ] Run `npm run refunds:preflight-gpt-triage -- --project-ref <project-ref>` and confirm required Supabase secret names exist without printing values; no `VITE_OPENAI_*` or `VITE_REFUND_GPT_*` setting exists.
