...
- [ ] Of synthetic weak, recipient-mismatched, and authenticated exact-customer delivery-status reports, only the exact-customer hard bounce pauses scheduled/automatic customer contact. It creates manager-visible recovery work and leaves deliberate manual case handling available. Gmail authorization revocation still affects only Gmail health/transport.
