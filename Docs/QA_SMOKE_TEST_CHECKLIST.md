...
- [ ] Corporate partner P0: generated partner PDF includes a senior-manager dashboard page, reporting period, gross sales, refund impact, tax impact, net sales, payout basis, unit/fee/cost assumptions, split calculation, amount owed, generated timestamp, and a partner-friendly report reference
- [ ] Corporate partner P0: generated partner PDF includes calculation support and a machine-level appendix with full readable machine labels, no machine IDs, no raw snapshot IDs, and no truncated table labels
- [ ] Corporate partner P0: blocking report warnings prevent PDF/CSV generation server-side rather than appearing as partner-facing caveats
