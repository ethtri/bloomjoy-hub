...
- [ ] Every active refund case shows one plain current state and one next step. Card cases distinguish **Needs information**, **Checking Nayax automatically**, **Ready for review**, **Multiple or no safe match**, **Refunding**, **Refund rejected**, **Check Nayax result**, **Completed**, and **Denied** without creating a second stored workflow; payment outcome and customer-message delivery remain separately labeled facts.
