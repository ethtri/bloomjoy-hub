...
- [ ] Portal Reports > Partner Dashboard can switch to Weekly, choose a completed reporting week, and show the selected week in the controls, KPI summary, machine rollups, calculation detail, warning/status notes, and PDF/CSV export metadata
