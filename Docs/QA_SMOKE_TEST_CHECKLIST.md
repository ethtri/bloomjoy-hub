...
- [ ] Confirm the acknowledgement includes the public reference and approved public refund/support links, contains no internal `/refunds?case=...` URL or sensitive-payment request, and carries standard automatic-response suppression headers.
