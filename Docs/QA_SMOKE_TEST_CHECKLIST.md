...
- [ ] The official-action target permits only a currently active manager mapped to the case's machine. Super Admin and Scoped Admin identities cannot approve/decline or invoke Nayax during the production pilot unless a separately approved, reason-required, audited break-glass policy is enabled and tested.
