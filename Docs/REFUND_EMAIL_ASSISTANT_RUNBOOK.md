...
Before this candidate can be considered release-ready, the same fresh workflow run must create exactly 44 reviewed synthetic screenshots plus these five strict, sanitized JSON artifacts:
