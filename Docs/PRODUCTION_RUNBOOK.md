...
2. Run `npm run refunds:release:check-production -- --project-ref <project-ref>`; retain its expected five-source production mismatch as sanitized evidence. Any different failure invalidates this bridge.
