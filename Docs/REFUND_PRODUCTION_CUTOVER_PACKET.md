...
4. Confirm the reviewed manifest covers all ten manifest-tracked Refund Operations functions and all 45 current required refund/Nayax migrations.
...
7. Preserve the completed isolated evidence: one original-thread first-contact acknowledgement, replay/later-reply suppression, private form continuation without a duplicate case, exact sole-manager assignment, and teardown. In a new explicitly approved email window, complete the remaining case-specific original-thread reply with the full current mapped-manager CC route. This is not approval to process a real customer case or enable broad polling.
