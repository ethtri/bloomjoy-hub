...
4. Confirm the reviewed target manifest covers all ten manifest-tracked Refund Operations functions and all 53 required refund/Nayax migrations, with an immutable exact canonical 51-migration predeployment bridge before migration 52.
