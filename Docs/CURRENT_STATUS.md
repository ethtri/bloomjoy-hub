...
- Current release blockers: production commerce preflight shows missing remote refund secrets by name, and production migration/function/secret rollout still requires explicit sponsor go/no-go. Local migration apply validation remains blocked on this workstation by Docker Desktop returning a 500 before SQL is applied, but the GitHub Supabase migration workflow provides clean CI migration evidence for the branch.
