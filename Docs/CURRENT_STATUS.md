...
- Scoped internal admin is not implemented yet: `admin_roles` still only accepts `super_admin`. Issue `#259` tracks the P1 Admin UI/access-management improvement, and migration `202604270003_adam_report_manager_access.sql` gives Adam temporary `report_manager` access to all active machines without granting super-admin.
