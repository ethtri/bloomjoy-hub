...
- Production migration rollout on `2026-04-26` confirmed a current Supabase physical backup, repaired the stale `202604260005` history entry, and applied migrations `202604260005` plus `202604260014` through `202604260017`.
- Final migration hygiene moves the non-canonical `2026042600051` partnership-party remove RPC migration to `202604260018` so future `supabase db push --dry-run` checks can reconcile local and remote order cleanly.
