...
- Contract-alignment slice `#217` adds legal partner names, weekly/monthly cadence terms, invoice/payment due terms, ownership/pricing authority fields, contract references, labeled deduction notes, and visible snapshot IDs in partner exports.
