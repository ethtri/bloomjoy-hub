...
- Admin Console IA uses `/admin` as the single internal workspace. Scoped Admins can enter Admin Console with zero machine grants, but machine records/actions remain limited to explicitly granted `reporting_machines`.
