...
- **Capability is proved:** at least one historical Tulsa `$7` refund that began through Bloomjoy's Nayax API path was later authoritatively confirmed as a real provider refund. The Lynx write API can refund; the present blocker is not API unavailability.
